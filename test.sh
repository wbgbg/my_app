...
echo 关注商品1219499
curl -u root:root -i -X POST -H "Content-Type: application/json" -d '{"hkd":"1219499"}' http://121.40.220.116:80/api/favorite/add
#echo 查询1219499价格
#curl -u root:root -i -X GET http://121.40.220.116:80/api/fetch/1219499
#echo 请求用户收藏的商品
